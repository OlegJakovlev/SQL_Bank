...
-- Get incoming transactions for each customer (summed by currency)
WITH incoming AS (
...
-- Get outgoing transactions for each customer (summed by currency)
outgoing AS (
